...
export class OfferSelectionComponent implements OnInit, SelectionMethods {
  ...
  getApplicantsForSelection(): void {
    ...
    this.applicationSelectionService.getApplicants({ApplicationStage: 6, PageNumber: '1', PageSize: '10'}).subscribe(pObs);
  }
